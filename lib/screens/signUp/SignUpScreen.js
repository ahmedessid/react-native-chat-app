...
import { ToastMsg } from "../../constants/strings";
  ...
  const handleSignUp = () => {
    if (
      ...
      if (!validator.isEmail(email))
        ToastAndroid.show(ToastMsg.incorrectEmail, ToastAndroid.SHORT);
      else if (!validator.isStrongPassword(password))
        ToastAndroid.show(ToastMsg.passwordIsNotStrong, ToastAndroid.SHORT);
      else {
        setLoading(true);
      ...
      ToastAndroid.show(ToastMsg.inputFillAllFields, ToastAndroid.SHORT);
    }
  };
